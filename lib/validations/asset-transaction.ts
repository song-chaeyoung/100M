...
export const assetTransactionBaseSchema = z.object({
...
export const assetTransactionSchema = assetTransactionBaseSchema.refine(
  (data) =>
    data.type !== "TRANSFER" ||
...
export const assetTransactionUpdateSchema =
  assetTransactionBaseSchema.partial();
